/* The popup wears the theme picked on lint.one: bridge.js copies it into
   extension storage whenever a lint.one page is open. It is applied before
   first paint from a local copy, then checked against storage, the same
   order shared/theme-boot.js follows with its cookie. */
(function () {
  'use strict';
  ...
  function apply(v) {
    v = v || {};
    var theme = RETIRED.hasOwnProperty(v.theme) ? RETIRED[v.theme] : v.theme;
